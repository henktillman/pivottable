      ...
      try {
        ...
        _fn = function(c) {
          ...
          if (keys.length > opts.menuLimit) {
            ...
            for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
              ...
              if (opts.inclusions[c]) {
                filterItemExcluded = (__indexOf.call(opts.inclusions[c], k) < 0);
              } else if (opts.exclusions[c]) {
                filterItemExcluded = (__indexOf.call(opts.exclusions[c], k) >= 0);
              }
          ...
          showFilterList = function(e) {
            var clickLeft, clickTop, _ref3;
            _ref3 = $(e.currentTarget).position(), clickLeft = _ref3.left, clickTop = _ref3.top;
            valueList.css({
              left: clickLeft + 10,
              top: clickTop + 10
            }).toggle();
